...
Como se para un fiber?? por medio de `Fiber#yield`. se puede ver este ejemplo en el [fiber_1](./examples/fibers_1.rb)
...
El ejemplo esta en este [archivo](./examples/socket/tcp_reactor.rb)
...
un ejemplo de un scheduler esta en la parte de [ejemplos](./examples/simple_scheduler.rb). Un poco basado en el reactor que implementamos en este [repositorio](https://github.com/arquitecturas-concurrentes/iasc-event-loop-reactor-ruby). En este repo, en [cada ciclo de nuestro reactor implementado](https://github.com/arquitecturas-concurrentes/iasc-event-loop-reactor-ruby/blob/master/src/reactor.rb#L117), hace un chequeo de [los eventos cada un quantum de tiempo determinado](https://github.com/arquitecturas-concurrentes/iasc-event-loop-reactor-ruby/blob/master/src/reactor.rb#L122).
...
Un ejemplo de como mejoraron los tiempos en su momento puede verse haciendo un simple benchmark, que [usamos](./extras/fibers_benchie.rb) y que comparan una version < 2.6 y una en Ruby 3
